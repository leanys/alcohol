...
angular
.module('core')
.controller('dmodalController', dmodalController);

dmodalController.$inject = ['$scope', '$state','$stateParams', '$uibModal', '$uibModalInstance', 'Authentication','headerService','test'];

  function dmodalController($scope, $state, $stateParams, $uibModal,$uibModalInstance , Authentication, headerService, test) {
    var vm = this;
    vm.close = close;
    $scope.test = test;
     vm.abv = 0;
